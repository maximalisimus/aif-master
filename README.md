...
С помощью таких вот псевдо-окон и происходит обработка выбранных пользователем действий. Всё остальное скрыто от глаз пользователя, т.е. обработка происходит незримо для пользователя и в автоматическом режиме.
