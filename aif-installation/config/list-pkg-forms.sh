...
_messangers_pkg=("$_telegramm_pkg" discord pidgin pidgin-otr)
...
if [[ "${_archi[*]}" == "x86_64" ]]; then
	...
	_gtkmm3_pkg=(gtkmm3)
	_gtkmm_dep_pkg=(libsigc++-3.0 cairomm pangomm atkmm pkgconf glibc atk pango cairo gdk-pixbuf2 lib32-gdk-pixbuf2)
	_gtk4_pkg=(gtk4 libcolord)
	_gtkmm4_pkg=(gtkmm-4.0)
