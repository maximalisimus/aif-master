...
_bootloader="n/a"
_Menu_Bootloader_Global=""
_Menu_Bootloader_Edit=""
_Menu_DM_Edit=""
...
_paprtitions=""                     # Partitions
_select_devices=""                  # Select devices
_select_devices_once=0              # Select devices Run Once
_select_root=""                     # Root part
_select_efi=""                      # EFI part
