######################################################################
##                                                                  ##
##            Dialog interface configuration functions              ##
##                                                                  ##
######################################################################
...
gen_dlgrc_conf()
{
    ...
    echo "" >> "$1"
    echo "# Shadow color" >> "$1"
    echo "shadow_color = (BLACK,BLACK,ON)" >> "$1"
    echo "" >> "$1"
    echo "# Dialog box color" >> "$1"
    echo "dialog_color = (BLACK,WHITE,OFF)" >> "$1"
    echo "" >> "$1"
    echo "# Dialog box title color" >> "$1"
    echo "title_color = (BLACK,WHITE,ON)" >> "$1"
    echo "" >> "$1"
    echo "# Dialog box border color" >> "$1"
    echo "border_color = (WHITE,WHITE,ON)" >> "$1"
    echo "" >> "$1"
    ...
    echo "button_key_active_color = button_active_color" >> "$1"
    echo "" >> "$1"
    echo "# Inactive button key color" >> "$1"
    echo "button_key_inactive_color = (RED,WHITE,OFF)" >> "$1"
    echo "" >> "$1"
    echo "# Active button label color" >> "$1"
    echo "button_label_active_color = (YELLOW,BLUE,ON)" >> "$1"
    echo "" >> "$1"
    echo "# Inactive button label color" >> "$1"
    echo "button_label_inactive_color = (BLACK,WHITE,ON)" >> "$1"
    echo "" >> "$1"
    ...
    echo "" >> "$1"
    echo "# Item color" >> "$1"
    echo "item_color = dialog_color" >> "$1"
    echo "" >> "$1"
    echo "# Selected item color" >> "$1"
    echo "item_selected_color = button_active_color" >> "$1"
    echo "" >> "$1"
    echo "# Tag color" >> "$1"
    echo "tag_color = title_color" >> "$1"
    echo "" >> "$1"
    echo "# Selected tag color" >> "$1"
    echo "tag_selected_color = button_label_active_color" >> "$1"
    echo "" >> "$1"
    echo "# Tag key color" >> "$1"
    echo "tag_key_color = button_key_inactive_color" >> "$1"
    echo "" >> "$1"
    echo "# Selected tag key color" >> "$1"
    echo "tag_key_selected_color = (RED,BLUE,ON)" >> "$1"
    echo "" >> "$1"
    echo "# Check box color" >> "$1"
    echo "check_color = dialog_color" >> "$1"
    echo "" >> "$1"
    echo "# Selected check box color" >> "$1"
    echo "check_selected_color = button_active_color" >> "$1"
    echo "" >> "$1"
    echo "# Up arrow color" >> "$1"
    echo "uarrow_color = (GREEN,WHITE,ON)" >> "$1"
    echo "" >> "$1"
    echo "# Down arrow color" >> "$1"
    echo "darrow_color = uarrow_color" >> "$1"
    echo "" >> "$1"
    ...
    echo "form_text_color = (WHITE,CYAN,ON)" >> "$1"
    echo "" >> "$1"
    echo "# Readonly form item color" >> "$1"
    echo "form_item_readonly_color = (CYAN,WHITE,ON)" >> "$1"
    echo "" >> "$1"
